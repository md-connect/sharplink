...
<body class="animsition">
					...
					<div class="flex-w w-full p-b-42">
						...
						<div class="size-212 p-t-2">
							...
							<p class="stext-115 cl6 size-213 p-t-18">
								PPL Bus Stop, Iyanaoba, 2 Task Force Rd, Ojo, Lagos.
							</p>
						</div>
					</div>
	...
	<!-- Map -->
	<div class="map">
		<div class="size-303" id="google_map" data-map-x="40.691446" data-map-y="-73.886787" data-pin="images/icons/logo-01.png" data-scrollwhell="0" data-draggable="1" data-zoom="11"></div>
	</div>
	...
	<!--===============================================================================================-->
	<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBLLPRQ2jftzQhSINa8ltzBRa2PVHyzTXU"></script>
