...
if (isset($_POST['signup'])) {
    ...
    if ($_FILES["passport"]["size"][$temp] > $totalBytes) {
        $UploadOk = false;
        array_push($errors, $passport_name . " file size is larger than the 20KB.");
    }

    $ext = pathinfo($name, PATHINFO_EXTENSION);
    if (in_array($ext, $extension) == false) {
        $UploadOk = false;
        array_push($errors, $passport_name . " is invalid file type.");
    }

    if (file_exists("images/passports" . "/" . $passport_name) == true) {
        $UploadOk = false;
        array_push($errors, $passport_name . " file is already exist.");
    }
    ...
    <strong>Email has been used by another customer!</strong>
        ...
        $insert = mysqli_query($conn, "INSERT INTO customers (name,email,phone,address,image, pwd) 
                VALUES('$name', '$email', '$phone', '$address', '$passport_name', '$pwd',)");
        if ($insert) {
            ...
            <div class="flex-w flex-tr">
                ...
                <div class="size-210 bor10 flex-w flex-col-m p-lr-93 p-tb-30 p-lr-15-lg w-full-md">
                    <form method="post" enctype="multipart/form-data" name="customerReg">
                        ...
                        <div class="bor8 m-b-20 how-pos4-parent">
                            <input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="mobile" placeholder="Enter your Mobile Number">
                        ...
                        <div class="bor8 m-b-20 how-pos4-parent">
                            <input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="pwd" placeholder="Choose a Password">
                            <img class="how-pos4 pointer-none" src="images/icons/password.png" alt="ICON">
                        </div>
                        <div class="right error"><?php echo $input_err; ?> </div>

                        <div class="bor8 m-b-20 how-pos4-parent">
                            <input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="email" placeholder="Confirm your Password">
                            <img class="how-pos4 pointer-none" src="images/icons/password.png" alt="ICON">
                        </div>
                        <div class="right error"><?php echo $input_err; ?> </div>
