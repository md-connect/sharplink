...
<body class="animsition">
	...
	<!-- Script for displaying product details -->
	<?php
	$pid = $_GET['pid'];
	...
	<section class="sec-product-detail bg0 p-t-65 p-b-60">
			...
			<div class="row">
					...
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="slick3 gallery-lb">
								<div class="item-slick3" data-thumb="images/<?php echo $picture1; ?>">
									<div class="wrap-pic-w pos-relative">
										<img src="images/<?php echo $picture1; ?>" alt="IMG-PRODUCT">

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="images/<?php echo $picture1; ?>">
											<i class="fa fa-expand"></i>
										</a>
									</div>
								</div>

								<div class="item-slick3" data-thumb="images/<?php echo $picture2; ?>">
									<div class="wrap-pic-w pos-relative">
										<img src="images/<?php echo $picture2; ?>" alt="IMG-PRODUCT">

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="images/<?php echo $picture2; ?>">
											<i class="fa fa-expand"></i>
										</a>
									</div>
								</div>

								<div class="item-slick3" data-thumb="images/<?php echo $picture3; ?>">
									<div class="wrap-pic-w pos-relative">
										<img src="images/<?php echo $picture3; ?>" alt="IMG-PRODUCT">

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="images/<?php echo $picture3; ?>">
											<i class="fa fa-expand"></i>
										</a>
									</div>
								</div>
				...
				<div class="col-md-6 col-lg-5 p-b-30">
					<div class="p-r-50 p-t-5 p-lr-0-lg">
						...
						<!--  -->
						<form method="post" action="product.php?action=add&pid=<?php echo $pid; ?>">
		...
		<div class="bg6 flex-c-m flex-w size-302 m-t-73 p-tb-15">
			...
			<span class="stext-107 cl6 p-lr-25">
				Categories: <?php echo $type; ?> , <?php echo $category; ?>
			</span>
		</div>
	</section>
		...
		<div class="container">
			...
			<div class="wrap-slick2">
				<div class="slick2">
					<?php
					$pid = $_GET['pid'];
					$sql = "SELECT * FROM products WHERE pd_type LIKE '$type' AND  pd_category LIKE '$category'";
					$query = $conn->query($sql);
					$j = 0;
							...
							<div class='item-slick2 p-l-15 p-r-15 p-t-15 p-b-15'>
								...
								<div class='block2'>
									<div class='block2-pic hov-img0'>
										<img src='images/$picture' alt='IMG-PRODUCT' height='300'>
