...
if (isset($_POST['upload'])) {
  ...
  if ($input_err == "") {
    $insert = mysqli_query($conn, "INSERT INTO products (pd_name, description, pd_category, pd_type, price, picture, picture2, picture3, keywords) 
                VALUES('$pd_name', '$desc', '$pd_category', '$pd_type', '$price', '$picture1', '$picture2', '$picture3', '$keywords')");
    if ($insert) {
                ...
                <form method="POST" action="#" enctype="multipart/form-data">
                  <div class="form-row">
                    ...
                    <div class="form-group col-6">
                      ...
                      <input id="inputText3" type="text" name="pd_name" class="form-control">
                      <?php echo "<div class='red'> $input_err</div>" ?>

                    </div>
                    <div class="form-group col-6">
                      <label for="inputText3" class="col-form-label">Product Description</label>
                      <input id="inputText3" type="text" name="desc" class="form-control">
                      <?php echo "<div class='red'> $input_err</div>" ?>

                    </div>
                    <div class="form-group col-6">
                      <label for="input-select">Product Category</label>
                      <select class="form-control" id="input-select" name="pd_category">
                    ...
                    <div class="form-group col-6">
                      ...
                      <select class="form-control" id="input-select" name="pd_type">
                  ...
                  <div class="form-group">
                    ...
                    <input id="inputText4" type="number" name="price" class="form-control" placeholder="Enter product price">
                    <?php echo "<div class='red'> $input_err</div>" ?>
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" id="exampleFormControlTextarea1" name="keywords" rows="3"></textarea>
                    <?php echo "<div class='red'> $input_err</div>" ?>
