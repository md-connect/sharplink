...
<body class="animsition">
	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1" style="background-image: url(images/cashmere.jpg);">
				...
				<div class="item-slick1" style="background-image: url(images/ankara2.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							<div class="layer-slick1 animated visible-false" data-appear="rollIn" data-delay="0">
								<span class="ltext-101 cl2 respon2">
									Men Native Wear 2020
								</span>
							</div>
				...
				<div class="item-slick1" style="background-image: url(images/suit2.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							<div class="layer-slick1 animated visible-false" data-appear="rollIn" data-delay="0">
								<span class="ltext-101 cl2 respon2">
									Men Suit Collection 2020
								</span>
							</div>
				...
				<div class="item-slick1" style="background-image: url(images/native.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							<div class="layer-slick1 animated visible-false" data-appear="rollIn" data-delay="0">
								<span class="ltext-101 cl2 respon2">
				...
				<div class="item-slick1" style="background-image: url(images/suit.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
				...
				<div class="item-slick1" style="background-image: url(images/ankara.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							<div class="layer-slick1 animated visible-false" data-appear="rollIn" data-delay="0">
								<span class="ltext-101 cl2 respon2">
	...
	<section class="bg0 p-t-23 p-b-140">
		<div class="container">
			...
			<div class="row isotope-grid">
				<?php
				$sql = mysqli_query($conn, "SELECT * FROM products LIMIT 16");
						...
						<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item <?php echo $row['pd_category'] . ' ' . $row['pd_type']; ?>">
							...
							<div class="block2">
								<div class="block2-pic hov-img0">
									<img src="images/<?php echo $row['picture']; ?>" alt="IMG-PRODUCT" height="230">
											...
											<div class="p-l-25 p-r-30 p-lr-0-lg">
												<div class="wrap-slick3 flex-sb flex-w">
													...
													<div class="slick3 gallery-lb">
														<div class="item-slick3" data-thumb="images/<?php echo $row['picture']; ?>">
															<div class="wrap-pic-w pos-relative">
																<img src="images/<?php echo $row['picture']; ?>" alt="IMG-PRODUCT">

																<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="images/<?php echo $row['picture']; ?>">
